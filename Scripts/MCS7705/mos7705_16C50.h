...
#define MOS7705_MSR_DELTA_CTS		0x01	/* CTS changed from last read */

#define MOS7705_MSR_DELTA_DSR		0x02	/* DSR changed from last read */

#define MOS7705_MSR_DELTA_RI		0x04	/* RI  changed from 0 -> 1 */

#define MOS7705_MSR_DELTA_CD		0x08	/* CD  changed from last read */

#define MOS7705_MSR_CTS			0x10	/* Current state of CTS */

#define MOS7705_MSR_DSR			0x20	/* Current state of DSR */

#define MOS7705_MSR_RI			0x40	/* Current state of RI */

#define MOS7705_MSR_CD			0x80	/* Current state of CD */
